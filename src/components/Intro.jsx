          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-8 relative px-4 sm:px-6 md:px-8 py-6 md:py-8 space-y-4 md:space-y-6 text-center md:text-left">
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-700">
                A complete roadmap for freshers and aspiring developers. Learn
                HTML, CSS, JavaScript, React, and modern tools — step by step.
              </p>

            
                <MiniButton onClick={handleScroll} className="flex flex-wrap items-center justify-center md:justify-start text-sm sm:text-base">
                  <ChevronLeft size={16} />
                  <span>/</span>
